...
# 10.times do 
# 	event = Event.create(start_date: Faker::Date.between(from: DateTime.now, to: Date.today+rand(1..50).day), duration: rand(60..320).minute.to_i ,title: Faker::Music.album, description: Faker::TvShows::GameOfThrones.quote, price: rand(1..1000), location: Faker::WorldCup.stadium , admin_id: user_id[rand(0..user_id.length)])
# end	
user = User.last(10)
user_id =[]
user.each	do |user| 
